...
letterMap = {
    ...
    "julia": "j",
    "krife": "k",        #crunch? #kidding? krog? # krux is like plus. careful of equal, colon, capital queen, geez.  My "kaput" is like "up". My "kilo" sometimes gets picked up as "killer"
    ...
    "odin": "o",     # oddity? #odd? okra? # oven is like one & bony. oomph is like win key. oodles is like middle. omen is like colon. omez is like home. orange is like end. oryx is like "echo".  My "osh" is like "as". My "omar" is like "home up". Kaldi thinks "osez" is like "acid". olga is like "alt dot". "oxide" is like "foxy" & "Maxo". "oozes" doesnt get picked up by Kaldi sometimes. "ounce" is like "acid". "odyssey" is like "lazy".
    ...
    "tosh": "t",        # trap? # trish is like three. tricky is like keys. teach is like itchy
    "unix": "u",          # "urge"? # careful of yang
    "video": "v",      # vest? # My "vix" is like "mix". My "vax" is like "backspace". My "van" is a bit like "then"
    "wages": "w",      # whale? # wintel is like hotel, end and enter. week is like queen. "wes" is like "worse"
    "x-ray": "x",    # Note: This can't be "xray", only "x-ray"!
    "yoke": "y",     # yank? # yeeshim is like shift, yiddish is like trish, yazzam is like home or down, yeast is like left. yellow is like "end left", yoke is like black. # "yang" is like "end". Careful of letter "u", home. "why" is like "white" that is like "why tay". Kaldi thinks "yeelax" is like "unix"
    "zimeesi": "z",    #zip? # zoobkoi is a bit like "close window" and "quotes"! zirconium? zircumference? zosepi? zidacious is like shift, zultani is like up home, zood is like undo and rude, zooki? zyxel is like click, zooch & zener are like insert! zulu, zoolex, zolex, zook and zeakbajived often aren't getting picked up! "zed" is like "said" and "set"
}
